...
class Home extends Component {
    ...
    showAllCategories = (categories,list_icon) => {
        return (
            categories.map((category, index) => {
                return (
                    <Link key ={index} href="#" className="category-small-box">
                        <i className={`ln ${list_icon[index%(list_icon.length)]}`}></i>
    ...
    render() {
        let list_icon = ["ln-icon-Bar-Chart", "ln-icon-Car", "ln-icon-Worker", "ln-icon-Student-Female", "ln-icon-Medical-Sign", "ln ln-icon-Plates", "ln-icon-Globe", "ln-icon-Laptop-3"]
        let style = {
                ...
                <div className="container">
                    <div className="sixteen columns">
                        ...
                        <div className="categories-boxes-container">
                            {this.showAllCategories(this.props.categories.slice(0,this.props.categories.length-this.props.categories.length%4<8?this.props.categories.length-this.props.categories.length%4:8),list_icon)}
                        </div>
